...
- API는 [[draft/terms/Web\|Web]] Back-end에서는 보통 API 서버를 지칭한다. 이 때 언급되는 API는 보통 [[HTTP\|HTTP]] API라고 볼 수 있다. HTTP를 통해서 서버 애플리케이션에 대한 조작 방식을 제공하는 것이다.  이 때에 서로 접촉하는 대상은 Back-end 애플리케이션과 Front-end 애플리케이션이 될 것이다.  
